...
\Old{Wallbert non-food warehouse} %\Multiple
Opposite the garage, off Monta\~no~St in northwest Albuquerque.
Use~\I{25} \Exit{228}.
...
\Location{Lumen Auto}
\Old{Voltison Motors car dealer}
South of Monta\~no~St in northwest Albuquerque.
Use \I{25} \Exit{228}.
...
\Location{Venture}
\Old{Wallbert food warehouse} %\Multiple
Northeast of the garage, off Monta\~no~St in northwest Albuquerque.
Use \I{25} \Exit{228}.
