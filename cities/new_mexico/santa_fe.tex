...
\Location{Apade}
\Old{Voltison Motors warehouse} %\Multiple
On Cerrillos~Rd at a signalled intersection, west side, off \NM{599} to the east.
...
\Location{Lumen Auto}
\Old{Voltison Motors dealership} %\Multiple
On Cerrillos~Rd at a signalled intersection, east side, off \NM{599} to the east.
