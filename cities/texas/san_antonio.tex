...
\Location{Asuma \Multiple \Rest \Weigh}
...
\Location{EliMax}
\Old{Plugged}
Next to the 42 Print warehouse, off \TX[Loop]{13} \WWWhiteRd\ north of \I{10} \Exit{580} in east San Antonio.

\Location{Enterpriser}
\Old{Wallbert food warehouse}
Off Gembler~Rd to the north, west of \TX[Loop]{13} \WWWhiteRd.
Take~\I{10} \Exit{580} in east San Antonio and head north.
...
On Gembler~Rd at Center~Pkwy off \TX[Loop]{13} \WWWhiteRd.
...
Take \TX[Loop]{13} \WWWhiteRd\ north from \I{10} \Exit{580} in east San Antonio and turn left onto Gembler~Rd, then left again onto Center~Pkwy.
...
On Zarzamora~St at \TX[Loop]{13} Military~Dr, northwest of \I{35} \Exit{150} in south San Antonio.
