...
Off Wilson~Wy north of \MLKing~Blvd, between \I{5} \Exit{471} and \CA{99} \Exit{252}.
...
By Airport~Wy off \MLKing~Blvd, east of \I{5} \Exit{471}.

\Location{Steeler}
In the Port of Stockton, on Washington~St by Navy~Dr.

\Location{Vortex \UndergroundTank \Gas \Rest \Weigh}
At the Vortex truck stop on \CA{4} Charter~Wy in southwest Stockton.
