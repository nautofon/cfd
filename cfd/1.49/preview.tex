\renewcommand*{\ChapterNameInPageHeader}[1]{#1 (1.49)}

\subject{City location descriptions for ATS 1.49}
\title{Company\!/Facility Directory}
\subtitle{Preview Edition}

\hypersetup{
	pdfsubject={City location descriptions for ATS 1.49},
...
\include{cities/california/_all}
